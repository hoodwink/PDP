...
module app.search {
    ...
    class SearchController {
        ...
        constructor(private SearchService: services.ISearchService,
            private $scope: ISearchControllerScope,  /// new updated
        ) {
            ...
            this.SearchService.getAnalyticalResults(commodities, pesticides, testClasses, years, resultOptionId)
             ...
             //this.getAnalatycalData(commodities, pesticides, testClasses, resultOptionId);
                    ...
                    $("#analyticalResultsGrid").jqGrid({
                        datatype: "local",
                        data: this.analyticalResults, // , page, limit, sortBy, direction, searchString
    ...
    angular
        ...
        .controller('app.search.SearchController', [
            ...
            'app.services.SearchService', '$scope', '$http',
