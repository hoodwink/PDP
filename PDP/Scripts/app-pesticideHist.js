var app = angular.module('app', [ //appPesticideHist
	'ui.grid',
	//'ui.grid.edit',
	'ui.grid.pagination',
	//'ui.grid.selection',
...
app.controller('MainCtrl', function ($scope, $http, uiGridConstants) {
    ...
    $scope.gridPesticideHist = {
        enableHorizontalScrollbar: 1,
        enableFiltering: true,
        enableGridMenu: true,
        exporterMenuCsv: true,
        exporterCsvFilename: 'PesticideHistory.csv',
        exporterPdfFilename: 'PesticideHistory.pdf',
        paginationPageSize: 500,
        //useExternalPagination: true,
       // useExternalSorting: true,

        columnDefs: [
			{ field: 'Pesticide_Name', displayName: 'Pesticide Name', width: 175 },
        ...
        exporterAllDataFn: function () {
            return getPage()
			.then(function () {
			    $scope.gridPesticideHist.useExternalPagination = false;
			    $scope.gridPesticideHist.useExternalSorting = false;
			    getPage = null;
			});
        },
    ...
    var getPage = function () {
        ...
        var url = "http://PdpApi/api/PesticideHist";
                
        $scope.loading = true;
        $scope.msg = "";
        return $http.get(url)
		.success(function (response) {
		    $scope.gridPesticideHist.totalItems = response.RecordCount;
		    $scope.gridPesticideHist.data = response; // data.slice(firstRow, firstRow + pageSize)
		}).error(function (data) {
